...
def get_recommendation(risk_data, schedule_data, location):
    ...
    if grade == "CRITICAL":
        action = "Suspend all non-essential outdoor work during peak hours and enforce mandatory 15-minute breaks every 2 hours per OSHA's High-Heat Trigger."
    elif grade == "HIGH":
        action = "Enforce mandatory paid breaks (15 min every 2 hours) as required under OSHA's High-Heat Trigger."
    else:
    ...
    return (
        f"**{grade} risk** at {location}, exceeding OSHA's 90°F High-Heat threshold for "
...
<body>
  ...
  <div class="rules">
    ...
    <div class="rule"><span class="icon">⏰</span> Take a 15-minute break every 2 hours — this is required by law</div>
  ...
  <div class="footer">
    Generated by HeatIQ using real-time FortyGuard temperature data · OSHA High-Heat Trigger: 90°F<br>
...
if "results" in st.session_state:
    ...
    if simple_mode:
        ...
        st.markdown("### ⏰ Take a 15-minute break every 2 hours — it's the law")
